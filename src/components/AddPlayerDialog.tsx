  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (currentPlayerCount >= maxPlayers) {
        throw new Error(`No puedes agregar más de ${maxPlayers} jugadores en esta categoría`);
      }
      ...
      toast({
        ...
        description: "El jugador se agregó correctamente al equipo",
      });
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Completa la información del nuevo jugador. Jugadores actuales: {currentPlayerCount}/{maxPlayers}
          </DialogDescription>
        </DialogHeader>
